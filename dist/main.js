...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _todos__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./todos */ \"./src/todos.js\");\n/* harmony import */ var _project__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./project */ \"./src/project.js\");\n/* harmony import */ var _DOMModules_DOMProjectModule__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DOMModules/DOMProjectModule */ \"./src/DOMModules/DOMProjectModule.js\");\n/* harmony import */ var _DOMModules_DOMTodoModule__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./DOMModules/DOMTodoModule */ \"./src/DOMModules/DOMTodoModule.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\n\n\n\n\n\n\nconst main = () => {\n    \n    let firstProject = (0,_project__WEBPACK_IMPORTED_MODULE_1__.Project)('First Project');\n    let firstTodo = (0,_todos__WEBPACK_IMPORTED_MODULE_0__.Todo)('title', 'first todo', \"1/13/22\", 'high');\n    firstProject.addTodo(firstTodo);\n\n    const projects = [firstProject];\n\n    let focusedProject = projects[0]; // project currently selected\n\n\n    function readyProjectForm() {\n        const addProjectBtn = _DOMModules_DOMProjectModule__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getAddProjectButton();\n        \n        addProjectBtn.addEventListener('click', createNewProject);\n        \n    };\n    \n    function readyTodoForm() {\n        const addTodoBtn = _DOMModules_DOMTodoModule__WEBPACK_IMPORTED_MODULE_3__[\"default\"].getAddTodoBtn();\n        addTodoBtn.addEventListener('click', createNewTodo);\n    }\n\n    function createNewProject() {\n        let newProjectTitle = _DOMModules_DOMProjectModule__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getNewProjectTitle();\n\n        projects.push((0,_project__WEBPACK_IMPORTED_MODULE_1__.Project)(newProjectTitle));\n        \n        _DOMModules_DOMProjectModule__WEBPACK_IMPORTED_MODULE_2__[\"default\"].updateProjectDisplay(newProjectTitle, `project-${projects.length - 1}`);\n        _DOMModules_DOMProjectModule__WEBPACK_IMPORTED_MODULE_2__[\"default\"].hideProjectForm();\n            \n\n        addProjectListener(projects.length - 1);\n    }\n\n    function createNewTodo() {\n        const formValues = _DOMModules_DOMTodoModule__WEBPACK_IMPORTED_MODULE_3__[\"default\"].getTodoFormValues();\n        const newTodo = (0,_todos__WEBPACK_IMPORTED_MODULE_0__.Todo)(formValues.title, formValues.description, formValues.dueDate, formValues.priority);\n\n        const projectIndex = projects.map((e) => e.getTitle()).indexOf(focusedProject.getTitle());\n        console.log(projectIndex);\n        \n        focusedProject.addTodo(newTodo);\n\n        showTodos(focusedProject, projectIndex);\n        _DOMModules_DOMTodoModule__WEBPACK_IMPORTED_MODULE_3__[\"default\"].hideTodoForm();\n\n    }\n\n    function addProjectListener(projectIndex) {\n        let newProject = _DOMModules_DOMProjectModule__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getProject(projectIndex);\n        newProject.addEventListener('click', (e) => selectProject(e.target.id));\n    }\n\n    function selectProject (projectId) {\n        let splitId = projectId.split('-')[1];\n\n        const project = projects[splitId];\n\n\n        showTodos(project, splitId);\n        focusedProject = project;\n    }\n\n    function showTodos(project, projectId) {\n        _DOMModules_DOMTodoModule__WEBPACK_IMPORTED_MODULE_3__[\"default\"].clearDisplay();\n\n        const todos = project.getTodos();\n\n        todos.forEach((todo, index) => {\n            let todoDiv = _DOMModules_DOMTodoModule__WEBPACK_IMPORTED_MODULE_3__[\"default\"].createBasicTodoDiv(todo.getTitle(), todo.getDueDate(), todo.getDescription(), todo.getPriority()); \n            \n            let editBtn = todoDiv.childNodes[4].childNodes[1];\n            let deleteBtn = todoDiv.childNodes[4].childNodes[2];\n\n            console.log(deleteBtn);\n\n            todoDiv.id = `${projectId}-${index}`;           \n            \n            _DOMModules_DOMTodoModule__WEBPACK_IMPORTED_MODULE_3__[\"default\"].updateDisplay(todoDiv);\n            \n            editBtn.addEventListener('click', () => updateTodo(todoDiv.id));\n            deleteBtn.addEventListener('click', () => deleteTodo(todoDiv.id));\n\n        });\n    }\n\n    function updateTodo(todoId) {\n        const saveBtn = _DOMModules_DOMTodoModule__WEBPACK_IMPORTED_MODULE_3__[\"default\"].getSaveEditedTodoBtn();\n\n        const projectId = todoId.split('-')[0];\n        todoId = todoId.split('-')[1];\n\n        saveBtn.addEventListener('click', () => {\n            const newTitle = saveBtn.parentNode.childNodes[0].value;\n            const newDesc = saveBtn.parentNode.childNodes[1].value;\n            const newDueDate = saveBtn.parentNode.childNodes[2].value;\n            const newPriority = saveBtn.parentNode.childNodes[3].value;\n            \n   \n            let newTodo = (0,_todos__WEBPACK_IMPORTED_MODULE_0__.Todo)(newTitle, newDesc, newDueDate, newPriority);\n\n            projects[projectId].getTodos()[todoId] = newTodo;\n\n            showTodos(projects[projectId], projectId);\n        });\n\n    }\n\n    function deleteTodo(todoId) {\n        const projectId = todoId.split('-')[0];\n        todoId = todoId.split('-')[1];\n\n        projects[projectId].getTodos().splice(todoId, 1);\n\n        showTodos(projects[projectId], projectId);\n    }\n\n\n    const newProjectBtn = document.querySelector('#new-project');\n    newProjectBtn.addEventListener('click', readyProjectForm);\n    \n    const newTodoBtn = document.querySelector('#new-todo');\n    newTodoBtn.addEventListener('click', readyTodoForm);\n    \n\n    _DOMModules_DOMProjectModule__WEBPACK_IMPORTED_MODULE_2__[\"default\"].updateProjectDisplay(firstProject.getTitle(), `project-${projects.length - 1}`);\n    addProjectListener(projects.length - 1);\n\n};\n\nmain();\n\n\n\n//# sourceURL=webpack://todojs/./src/index.js?");
